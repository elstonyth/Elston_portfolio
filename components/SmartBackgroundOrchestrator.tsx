...
// Smart particle system - Three.js for desktop, Canvas for mobile
const OptimizedHeroBackground = lazy(() => import('./OptimizedHeroBackground').then(m => ({ default: m.OptimizedHeroBackground })));
const ModernParticleBackground = lazy(() => import('./ModernParticleBackground').then(m => ({ default: m.ModernParticleBackground })));
...
export const SmartBackgroundOrchestrator: React.FC = () => {
  ...
  useEffect(() => {
    ...
    // Use Three.js only on desktop with WebGL and good performance
    setUseThreeJS(isDesktop && hasWebGL && quality !== 'low');
  }, [quality]);
  ...
  return (
    <>
      ...
      {/* Layer 1: Smart Particle System (z-0) */}
